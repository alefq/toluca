...
public class TableEvent {
    ...
    public TableEvent
    (
    int event, Table table, Player player, int value
    ) {
    ...
    public static void main(String[] args) {
        ...
        tEvents = new TableEvent[] {
            ...
            new TableEvent(TableEvent.EVENT_playerSit, null, new Player(), -1),
            new TableEvent(TableEvent.EVENT_tableLocked, null, new Player(), 2)
        };
