	...
	public void xmlReadSignSent(Object o)
			{
						...
						if (o instanceof Element)
						{
							...
							if(aux.compareTo("SignSent")==0){
								...
								System.out.println("La se�a es: "+signAux);
			...
			if (aux.compareTo("TrucoPlay") == 0)
			{
				...
				/*	try {
							...
							Table tabela = (Table)getTables().get(tableid);
								...
								System.out.println("LA TABLA ES NULL EN EL COMUNICATOR CLIENT M�todo xmlReadCantarTanto ");
	...
	public void xmlReadTurno(Object o)
	{
		...
		if (o instanceof Element)
		{
			...
			if (aux.compareTo("Turno") == 0)
			{
				...
				// TODO Quiloooooooombo armamos ac� con el gameNumber y tableNumber
				TrucoEvent te =
				new TrucoEvent(
				elGameDeAca,
				hand,
	...
	public void xmlreadSendCardsAlg(Object o)
	{
		...
		if (o instanceof Element)
		{
			...
			if (aux.compareTo("SendCards") == 0)
			{
				...
				{
					System.out.println("LA TABLA ES NULL EN EL COMUNICATOR CLIENT M�todo xmlreadSendCardsAlg ");
					e.printStackTrace(System.out);
					throw e;
				}
				finally
...
/*        System.out.println("El pacochi debe viajar por los cables agora!");
		...
		// Ac�, en vez de getTypeEvent dec�a getHandNumber
		if (event.getTypeEvent() == TrucoEvent.ENVIAR_CARTAS)
			...
			new Exception(
			//TODO PENSAR EN UN M�TODO EST�TICO QUE TE DEVUELVA UN TP DADO UN TE O SI NO EN UNIFICAR LOS NROS.
		...
		if (o instanceof Element)
		{
			...
			if (aux.compareTo("GameStarted") == 0)
			{
				...
				//ESTO ESTA COMENTADO PORQUE hay metodos no implementados todavia en el TableServer
								...
								System.e.println("LA TABLA ES NULL EN EL COMUNICATOR CLIENT EN EL M�todo xmlReadGameStarted");
								e.printStackTrace(System.out);
								throw e;
								}*/
