...
public class TrucoHandClient extends TrucoHand{
    ...
    public TrucoHandClient(TrucoGameClient game, int reparteCartas) {
        ...
        statusTableClie = new TrucoStatusTableCliente(cantidadDePlayers); //se crea un estado de la mesa
    ...
    public void recibirCartas(TrucoPlayer tp, TrucoCard cartas[]){
        ...
        System.out.println("TrucoHandCLIENTE recibe cartas :)");
        System.out.println("para: "+tp.getName());
    }
