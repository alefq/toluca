...
implements ChatPanelContainer, TableListener
{
	...
	{	/** lock-end */
        ...
        /*
         * Este metodo ingresa a un Player al Room, es decir se le
         * muestra en la Tabla del Ranking
         */
	...
	{        /** lock-end */
		...
		{
			Table tabela=(Table)e.nextElement();
	...
	{        /** lock-end */
        ...
        /*
         * Ingresa al Player en la Tabla Principal
         * como Observador
         */
	...
	public void playerLeft(TableEvent event) {
           ...
           // mainTable.removeplayer(event.getPlayer(), event.getTable().getTableNumber());
	}
	...
	/* 
	 * Cuando el player se sento en una mesa,
         * se le carga en la Tabla Principal.
         */
	public void playerSit(TableEvent event) {
		// TODO Auto-generated method stub
            ...
            System.out.println("El player en la tabla: "+event.getTable().getPlayer());
            Table tabela=event.getTable();
            TrucoPlayer jug=tabela.getPlayer();
            System.out.println("El player que se sienta es"+jug.getName());
            //mainTable.addPlayer(jug, tabela.getTableNumber(), tabela.getChair(jug));
            
	}
	public void setearPlayerTable(TrucoPlayer player,Table tabela,int chair)
	{
		System.out.println("Se va a sentar al player Parche de Redes el CommunicatorClient le llama a este");
	...
	public void playerJoined(TrucoPlayer player) {
            ...
            //mainTable.addObserver( player.getPlayer(), player.getTable().getTableNumber());
	}
